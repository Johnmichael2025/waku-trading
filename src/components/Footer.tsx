...
export default function Footer() {
  ...
  return (
    <footer className={clsx(styles.footer, pathname?.includes("client-portal") ? 'ml-[270px] mt-10' : '')}>
      <Link href="/" rel="home">
      ...
      <p>
        ...
        terms and conditions. We also ask you to carefully review the Alfabourse 
        policies that govern our provision of services. Trading in the

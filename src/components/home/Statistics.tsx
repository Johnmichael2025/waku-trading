    ...
    <div className={styles["bg-left"]}>
      ...
      <div className="flex justify-around mt-20 gap-10">
        ...
        <div className={styles['tariff-plans']}>
          ...
          <p>Our accounts are the key to convenience and individuality in the world of financial transactions. We provide different options, each tailored to your needs and trading strategy. Choose your leverage level, customize conditions and tools to suit your goals.</p>

  ...
  return (
    <>
      <Banner
        ...
        description="Essentra Finance provides detailed information about its terms and conditions. Before cooperating with us, we recommend that you examine this documentation to understand our policies."

  ...
  return (
    <>
      <Banner
        ...
        description="Find the right points to enter and exit positions. Enlarge your portfolio with promising products that have high liquidity. We at Essentra Finance will help you increase your capital."

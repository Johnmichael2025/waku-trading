  ...
  return (
    <>
      <Banner
        ...
        description="We want you to fully enjoy trading, using all opportunities to increase successful operations. For this purpose, Essentra Finance provides numerous tools, including the ‘Economic Calendar’."
